...
import { Menu, X, ChevronDown, ChevronUp, Award, Briefcase, GraduationCap, Mail, Phone, MapPin, Download, ExternalLink, FolderGit2, Users } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="max-w-6xl mx-auto px-6 pb-12">
        ...
        <section id="projects" className="py-8">
          <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              <FolderGit2 size={28} style={{ color: PRIMARY }} />
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center gap-3">
                  <ExternalLink size={20} style={{ color: PRIMARY }} />
                  <div>
              ...
              >
                <div className="flex items-center gap-3">
                  <ExternalLink size={20} style={{ color: SECONDARY }} />
                  <div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                >
                  <ExternalLink size={18} className="mt-1 flex-shrink-0" />
                  <span className="group-hover:underline">
                    From Text Annotation To An Auto-Regressive Language Model For Sentiment Analysis 
                    In South African Financial Reviews
                  </span>
                </a>
            ...
            <div className="mt-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <a
                  ...
                  style={{ borderColor: SECONDARY }}
                >
                  <Users size={24} style={{ color: SECONDARY }} />
                  <div>
